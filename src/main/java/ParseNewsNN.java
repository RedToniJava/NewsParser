...
public class ParseNewsNN extends ParseNewsNsn implements Runnable {
    ...
    public void run() {
        ...
        while (startParse) {
            ...
            try {
                String urlNN = "https://newsroom24.ru/news/";
                doc = Jsoup.connect(urlNN).get();
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            elements.forEach(e -> {
                lastNews.add(e.text());
                lastNewsUrl.add("https://newsroom24.ru" + newsURL(e.toString()));
                textsNews.add(newsText("https://newsroom24.ru" + newsURL(e.toString())));
    ...
    private String newsText(String url) {
        ...
        Elements elements = docTextNews.select("div.main_text_ip");
